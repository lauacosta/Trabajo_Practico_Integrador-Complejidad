...
def backtracking(
    ...
    gasto_con_relleno = gasto + modelo_actual[1] * distancia
    print(gasto_con_relleno)
    mejor_gasto, mejor_seleccion = (
        backtracking(
            idx + 1,
            opciones,
...
def main():
    ...
    total_cost, seleccion = min_paradas_min_costo(estaciones, [])
